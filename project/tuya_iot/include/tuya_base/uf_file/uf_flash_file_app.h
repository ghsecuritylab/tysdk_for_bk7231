...
OPERATE_RET uf_file_app_init(const UCHAR_T *p_encrypt_key,const UINT_T encrypt_key_len);
...
***********************************************************/
__UF_FLASH_FILE_APP_EXT \
UINT_T uf_file_lseek(VOID *fd,UINT_T offset,uf_mode_t fromwhere);
...
***********************************************************/
__UF_FLASH_FILE_APP_EXT \
OPERATE_RET uf_file_get_file_size(CONST UCHAR_T *name);
