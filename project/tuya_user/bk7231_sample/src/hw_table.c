...
static CTRL_CHANNEL channels[] = 
{
    ...
    {
        // 继电器
        .relay  = {.type = IO_DRIVE_LEVEL_HIGH, .pin = TY_GPIOA_25},
        // 按钮
        .button = {TY_GPIOA_19,TRUE,LP_INVALID,0,50,NULL},
        // 通道状态指示灯
        .led    = {.type = IO_DRIVE_LEVEL_LOW, .pin = TY_GPIOA_28},
        // 绑定dpid
        .dpid   = 1,
...
HW_TABLE g_hw_table = 
{
    ...
    .wifi_stat_led = {.type = IO_DRIVE_LEVEL_LOW, .pin = TY_GPIOA_8},
    .rst_button = {TY_GPIOA_19,TRUE,LP_ONCE_TRIG,KEY_RST_TIME,50,key_process},
    .channels = channels
};
