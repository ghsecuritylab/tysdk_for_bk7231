...
#define FCLK_PWM_ID           PWM3

#define FCLK_PWM_DURATION     1
...
#if (FCLK_PWM_DURATION > FCLK_DURATION_MS)
#error "attention:FCLK_DURATION_MS >= FCLK_PWM_DURATION"
#else
#define FCLK_CHUNK_COUNT      (FCLK_DURATION_MS / FCLK_PWM_DURATION)
#endif

typedef void (*fclk_user_cb)(void);
...
extern uint32_t fclk_register_cb(fclk_user_cb cb);
